...
pub fn write_colour(buf: &mut BufWriter<File>, pixel_colour: RGBcol, samples_per_pixel: i32) {
    // need to scale according to number of samples for basic anti-aliasing
    let r: f64 = pixel_colour.r()/(samples_per_pixel as f64);
    let g: f64 = pixel_colour.g()/(samples_per_pixel as f64);
    let b: f64 = pixel_colour.b()/(samples_per_pixel as f64);
    write!(*buf, "{} {} {}\n",
